export const m = {
  ...
  SSH_Config: 'SSH 设置',
  SSH_Project_Path: '项目路径',
  SSH_Fronted_Path: '前端路径',
  SSH_Backend_Path: '后端路径',
  SSH_Judgeserver_Path: '评测机路径',
  SSH_Fronted_RelativePath: '前端相对路径',
  SSH_Backend_RelativePath: '后端相对路径',
  SSH_Judgeserver_RelativePath: '评测机相对路径',
  Restart_Fronted: '重启前端',
  Restart_Backend: '重启后端',
  Restart_Judgeserver: '重启判题',
  Seem_Docker: '查看容器',
