export const m = {
  ...
  Container_CPU: 'CPU %',
  Container_MEM: 'Mem Usage / Limit',
  Container_MEM_Usage: 'Mem %',
  Container_NET: 'Net I/O',
  Container_BLOCK: 'Block I/O',
  ...
  Import_User_Tips11: 'There are four columns of data: username, email, and password cannot be empty. Otherwise, the data in this row may fail to be imported.',
  Import_User_Tips12: 'The first line does not need to write the four column names ("username", "password", "email", "school").',
  Import_User_Tips13: 'There are two columns of data: username cannot be empty. Otherwise, the data in this row may fail to be imported.',
  Import_User_Tips14: 'The first line does not need to write the two column names ("username", "password").',
  ...
  Remote_Tips_GYM: 'Example url: `https://codeforces.com/gym/105387/problem/A` - The corresponding problem ID is [105387A]',
  Remote_Tips_SPOJ: 'Example url: `https://www.spoj.com/problems/TEST` - The corresponding problem ID is [TEST]',
  Remote_Tips_AC: 'Example url: `https://atcoder.jp/contests/abc100/tasks/abc100_a` - The corresponding problem ID is [abc100_a]',
  Remote_Tips_LIBRE: 'Example url: `https://loj.ac/p/1000` - The corresponding problem ID is [1000]',
  Remote_Tips_SCPC: 'Example url: \n Regular problem: `http://scpc.fun/problem/9001` - The corresponding problem ID is [9001]\n Contest problem: `http://scpc.fun/contest/1143/problem/A` - The corresponding problem ID is [1143_A]',
  ...
  // tools
  Admin_StaticRank_List: 'Admin StaticRank List',
  Admin_Create_StaticRank: 'Admin Create StaticRank',
  Admin_Edit_StaticRank: 'Admin Edit StaticRank',
  Tools_Admin: 'Tools Admin',
  Ranks_Admin: 'Ranks Admin',
  The_Input_Cids: 'Quickly input cids, separated by `+`, or an already generated uid',
  The_Selected_Cids: "Selected cids (currently supporting 'nyoj', 'cf', 'gym', 'vj', 'hdu', 'nowcoder', 'pta', 'xcpc' )",
  The_Selected_Cids_Tips: "When querying NYOJ competitions, no prefix is needed by default. 'cf' and 'gym' use the same account.",
  Invalid_Cid_Error: "cid can only be a pure number, or a string containing 'cf', 'gym', 'vj', 'hdu', 'nowcoder', 'pta', 'xcpc'. ]",
  Add_Cid_Error: 'Please do not add duplicate cid!',
  Ranks_Account: 'Account for Ranking Scraping',
  Ranks_Account_Tips: 'For security and confidentiality purposes, the account used for queries will be one of the accounts from the `Account Configuration`.',
  Import_User_Tips9: 'There are two columns of data: Username and Real Name',
  Import_User_Tips10: 'The first row does not need to include the column names ("Username", "Real Name")',
  Generate_Title: 'Generate Title',
  Delete_All: 'Delete All',
  Delete_Statistic_Tips: 'This action will delete the series list and related data, do you want to continue?',
  Click_Change_ContestPercent: 'Click Change ContestPercent',
  Change_ContestPercent: 'Change ContestPercent',
  Crawl: 'Crawl',
  Above_Tip: 'The above actions are part of the web scraping process',
  Follow_Tip: 'The following actions are part of the filtering process',
};
