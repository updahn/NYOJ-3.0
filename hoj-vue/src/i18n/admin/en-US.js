export const m = {
  ...
  The_Selected_Cids: "Selected cids (currently supporting 'nyoj', 'cf', 'gym', 'hdu', 'nowcoder', 'pta', 'xcpc' )",
  The_Selected_Cids_Tips: "When querying NYOJ competitions, no prefix is needed by default. 'cf' and 'gym' use the same account.",
  Invalid_Cid_Error: "cid can only be a pure number, or a string containing 'cf', 'gym', 'hdu', 'nowcoder', 'pta', 'xcpc'. ]",
