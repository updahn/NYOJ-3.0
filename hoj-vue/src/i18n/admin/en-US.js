export const m = {
  ...
  SSH_Project_Path: 'Project Path',
  SSH_Fronted_Path: 'Fronted Path',
  SSH_Backend_Path: 'Backend Path',
  SSH_Judgeserver_Path: 'Judgeserver Path',
  SSH_Fronted_RelativePath: 'Fronted Relative Path',
  SSH_Backend_RelativePath: 'Backend Relative Path',
  SSH_Judgeserver_RelativePath: 'Judgeserver Relative Path',
  Restart_Fronted: 'Restart Fronted',
  Restart_Backend: 'Restart Backend',
  Restart_Judgeserver: 'Restart Judgeserver',
  Seem_Docker: 'Seem Docker',
