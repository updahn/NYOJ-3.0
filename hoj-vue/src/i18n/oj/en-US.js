export const m = {
  ...
  The_username_not_exists: 'The username not exists.',
  The_username_check_root: 'The username is the root',
  Register_Realname: 'Please Enter Realname',
  ...
  From_the_Signup: 'From the Signup',
