export const m = {
  ...
  NavBar_Logout: '退出登录',
  Dialog_Login: '登录',
  Dialog_ResetPasswordLogin: '重置密码登录',
  Dialog_Register: '注册',
  ...
  Welcome_Back: '欢迎回来~',
  Password_Validation_Message: '密码必须由数字、大小写字母、特殊字符组合',
  ...
  Diversity: '多样性',
  Diversity_Desc: '支持Codefoces，HDU，POJ，GYM，AtCoder，SPOJ，LIBRE，SCPC，QOJ，NSWOJ，NEWOJ，Vjudge，Dotcpp的远程判题',
  Available: '有效',
  Faulty: '不完善',
