  ...
  <div>
    <el-card>
      ...
      <vxe-table
        ...
        align="center"
      >
        <vxe-table-column field="gid" min-width="64" :title="$t('m.Group_Number')" show-overflow>
          <template v-slot="{ row }">
            <el-link type="primary" @click="goGroup(row.gid)" style="font-size: 13px;">{{ row.gid }}</el-link>
          </template>
        </vxe-table-column>
        <vxe-table-column min-width="64" field="id" :title="$t('m.Problem')+' ID'">
          <template v-slot="{ row }">
            <el-link type="success" @click="goEdit(row.id)" style="font-size: 13px;">{{ row.id }}</el-link>
          </template>
        </vxe-table-column>
        ...
        <vxe-table-column field="type" min-width="64" :title="$t('m.Type')" show-overflow>
          <template v-slot="{ row }">
        ...
        <vxe-table-column field="author" min-width="130" :title="$t('m.Author')" show-overflow>
          <template v-slot="{ row }">
            <el-link
              type="primary"
