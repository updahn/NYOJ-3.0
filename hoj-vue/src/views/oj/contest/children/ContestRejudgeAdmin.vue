<template>
  <el-card shadow="always">
    ...
    <vxe-table border="inner" stripe auto-resize align="center" :data="contestProblems">
      ...
      <vxe-table-column field="displayId" :title="$t('m.Problem_ID')" min-width="100"></vxe-table-column>
      <vxe-table-column field="displayTitle" :title="$t('m.Title')" min-width="150" show-overflow></vxe-table-column>
      <vxe-table-column field="ac" :title="$t('m.AC')" min-width="80"></vxe-table-column>
